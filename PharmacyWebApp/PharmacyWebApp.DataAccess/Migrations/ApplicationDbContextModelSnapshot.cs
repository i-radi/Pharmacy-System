...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PharmacyWebApp.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PharmacyWebApp.Models.OrderForDetail", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PharmacyWebApp.Models.OrderForHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PharmacyWebApp.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PharmacyWebApp.Models.OrderForDetail", b =>
                {
                    b.HasOne("PharmacyWebApp.Models.OrderForHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("PharmacyWebApp.Models.Product", b =>
                {
                    b.HasOne("PharmacyWebApp.Models.Brand", "Brand")
                        .WithMany()
                        .HasForeignKey("BrandId");

                    b.HasOne("PharmacyWebApp.Models.Category", "Category")
                        .WithMany()
